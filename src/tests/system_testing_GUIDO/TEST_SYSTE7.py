...
class TestSYSTE7():
  ...
  def test_sYSTE7(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("https://github.com/bundler/bundler")
    self.driver.find_element(By.CSS_SELECTOR, "input:nth-child(2)").click()
    self.driver.find_element(By.CSS_SELECTOR, "input:nth-child(2)").send_keys("2019-06-01")
    ...
    try:
      ...
      assert True, "The system returned correct data"
    except TimeoutException:
      assert False, "The system didn't return correct data"
